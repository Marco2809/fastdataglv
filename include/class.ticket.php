...
class Ticket {
    ...
    function load($id=0) {
        ...
        $sql='SELECT  ticket.*, lock_id, dept_name, ref_num, cr, status_sym, group_last_name,category_sym,
        customer_location_l_addr7, customer_location_l_addr1, customer_location_l_addr2, customer_location_l_addr3, customer_phone_number,
        customer_middle_name,customer_last_name,zz_date6,zz_dt_callagt,zz_dt_recall,affected_resource_zz_wam_string1,affected_resource_zz_wam_string8, affected_resource_zz_wam_string9, affected_resource_zz_wam_string2, affected_resource_zz_wam_string15,
        zz_tecreason,zz_dt_restart,zz_dt_clmghw,zz_mgnote,zz_data_inizio_intervento_man, customer_zz_top_sp_ap_lun,
        zz_guasto_riscontrato,zz_intervento_manutentore,zz_ricambi_sostituiti,zz_esito_op,zz_desc_op_eff,nome,category_analisiguasto,area_descrizione_intervento,desc_statocomponente,cod_intervento,tec_contatto_phone,data_partenza'
            .' ,IF(sla.id IS NULL, NULL, '
                .'DATE_ADD(ticket.created, INTERVAL sla.grace_period HOUR)) as sla_duedate '
            .' ,count(distinct attach.attach_id) as attachments'
            .' FROM '.TICKET_TABLE.' ticket '
            .' LEFT JOIN '.TICKET_TABLE.'__cdata as cdata ON ( ticket.ticket_id=cdata.ticket_id)'
            ...
            .' LEFT JOIN ost_banche as banche
                ON ( cdata.customer_last_name=banche.abi) '
    ...
    /* inizio funzioni customizzate */
    function problem() {
       return $this->ht['ref_num'];
    }
    function termid() {
       return $this->ht['cr'];
    }
    ...
    function ora_ordine() {
       return $this->ht['data_partenza'];
    }

    function urgenza() {
       return $this->ht['category_sym'];
    }

    function stato_cliente() {
       return $this->ht['status_sym'];
    }

    function gruppo() {
       return $this->ht['group_last_name'];
    }

    function localita_ufficio() {
       return $this->ht['customer_location_l_addr7'];
    }

    function provincia_ufficio() {
       return $this->ht['customer_location_l_addr1'];
    }

    function orario_apertura() {
       return $this->ht['customer_zz_top_sp_ap_lun'];
    }

    function giornochiusura_1() {
       return $this->ht['area_descrizione_intervento'];
    }
    function giornochiusura_2() {
       return $this->ht['desc_statocomponente'];
    }
    function giornochiusura_3() {
       return $this->ht['cod_intervento'];
    }

    function via_ufficio() {
       return $this->ht['customer_location_l_addr2'];
    }

    function cap() {
       return $this->ht['customer_location_l_addr3'];
    }

    function telefono_ufficio() {
       return $this->ht['customer_phone_number']?:$this->ht['tec_contatto_phone'];
    }

    function cellulare() {
       return $this->ht['tec_contatto_phone']?:'';
    }

    function denominazione_ufficio() {
       return $this->ht['customer_middle_name'];
    }

    function frazionario() {
       return $this->ht['customer_last_name'];
    }
    //funzioni presa in carico

    function data_previsto_intervento() {
       return $this->ht['zz_date6'];
    }
    //funzioni sospensioni
    function data_contatto_utente() {
       return $this->ht['zz_dt_callagt'];
    }

    function data_appuntamento() {
       return $this->ht['zz_dt_recall'];
    }

    function motivo_sospensione() {
       return $this->ht['zz_tecreason'];
    }
    //funzioni ripresa
    function data_ripresa_attivita() {
       return $this->ht['zz_dt_restart'];
    }
    //funzioni chiusura
    function data_proposta_chiusura() {
       return $this->ht['zz_dt_clmghw'];
    }
    function note_manutentore() {
       return $this->ht['zz_mgnote'];
    }
    function hw() {
       return $this->ht['affected_resource_zz_wam_string1'];
    }
    function string9() {
       return $this->ht['affected_resource_zz_wam_string9'];
    }
    function string2() {
       return $this->ht['affected_resource_zz_wam_string2'];
    }
    function string8() {
       return $this->ht['affected_resource_zz_wam_string8'];
    }
    function string15() {
       return $this->ht['affected_resource_zz_wam_string15'];
    }
    function collegamento() {
       return $this->ht['category_analisiguasto'];
    }
    function inizio_intervento() {
       return $this->ht['zz_data_inizio_intervento_man'];
    }
    function guasto_riscontrato() {
       return $this->ht['zz_guasto_riscontrato'];
    }
    function intervento() {
       return $this->ht['zz_intervento_manutentore'];
    }
    function ricambi_sostituiti() {
       return $this->ht['zz_ricambi_sostituiti'];
    }
    function esito_operazioni() {
       return $this->ht['zz_esito_op'];
    }
    function operazioni_effettuate() {
       return $this->ht['zz_desc_op_eff'];
    }

    /* fine funzioni customizzate */
    ...
    //Status helper.
    function setStatus($status, $comments='', $set_closing_agent=false) {
        global $thisstaff;
        ...
        switch($status->getState()) {
            case 'closed':
                $res_assegnato=db_query('select firstname, lastname from ost_staff s left join ost_ticket t on (s.staff_id=t.staff_id) where t.ticket_id='.db_input($this->getId()));
                while ($row = db_fetch_array($res_assegnato)) {
					$nome=$row['firstname'];
        ...
        $guasto_riscontrato = $row['zz_guasto_riscontrato'];
   ...
   function onOverdue($whine=true, $comments="") {
    ...
    function markOverdue($whine=true) {
        ...
        //if($this->getStatusId()==21 or $this->getStatusId()==8)
          //return $this->clearOverdue();

        //if($this->isOverdue() or $this->getStatusId()==21 or $this->getStatusId()==8)
        if($this->isOverdue())
            return true;
    ...
    function pdfExport_app($psize='Letter', $notes=false,$img1,$img2) {
        global $thisstaff;

        require_once(INCLUDE_DIR.'class.pdf_app.php');
        if (!is_string($psize)) {
            if ($_SESSION['PAPER_SIZE'])
                $psize = $_SESSION['PAPER_SIZE'];
            elseif (!$thisstaff || !($psize = $thisstaff->getDefaultPaperSize()))
        ...
        $pdf = new Ticket2PDF($this, $psize, $notes,$img1,$img2);
        $name='Ticket-'.$this->getNumber().'.pdf';
   ...
   /*============== Static functions. Use Ticket::function(params); =============nolint*/
    ...
    function getIdByRef_num($number) {

        if(!$number)
            return 0;

        $sql ='SELECT ticket_id FROM ost_ticket__cdata WHERE ref_num='.db_input($number);
    ...
    static function create($vars, &$errors, $origin, $autorespond=true,
        ...
        $source = $source ?: 'Web';
        $datacreazione =  $vars['source']=='API'?date('Y-m-d H:i:s',$vars['zz_date1']):date('Y-m-d H:i:s');

        //We are ready son...hold on to the rails.
        $number = $topic ? $topic->getNewTicketNumber() : $cfg->getNewTicketNumber();
        //$sql='INSERT INTO '.TICKET_TABLE.' SET created=NOW() '
        $sql='INSERT INTO '.TICKET_TABLE.' SET created='.db_input($datacreazione)
            .' ,lastmessage= NOW()'
            .' ,user_id='.db_input($user->getId())
        ...
        //if($vars['duedate'] && !strcasecmp($origin,'staff')) //rimosso controllo sull'origine per permettere a soap di sovrascrivere la duedate
        if($vars['duedate'])
        ...
        if(!($reso=db_query("select comm_id from ost_commesse where user_id=".$vars['userId'].";")) || !db_num_rows($reso)){
		db_query("INSERT INTO `ost_commesse`(`user_id`, `codice`, `nome`, `cliente`, `gruppo`) VALUES (".$vars['userId'].",".$vars['userId'].",".db_input($vars['name']).",".db_input($vars['name']).",".$vars['userId'].")");
		$comm_id=db_insert_id();
		db_query("UPDATE `ost_ticket__cdata` SET `comm_id`=".$comm_id." WHERE ticket_id=".$id.";");
		}else{

			while($riga= db_fetch_row($reso)) {
            $comm_id = $riga[0];
        }
    ...
    function checkOverdue() {
        ...
        $sql='SELECT ticket_id FROM '.TICKET_TABLE.' T1 '
            ...
            .' )  AND T1.status_id NOT IN (21,8) ORDER BY T1.created LIMIT 50'; //Age upto 50 tickets at a time?
