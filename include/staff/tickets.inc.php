...
$query_lav="$qselect $qfrom $qwhere "."AND (ticket.status_id=16 OR ticket.status_id=11 OR ticket.status_id=23 OR ticket.status_id=12 OR ticket.status_id=17 OR ticket.status_id=18 OR ticket.status_id=19 OR ticket.status_id=22)"." ORDER BY $order_by $order LIMIT ".$pageNav_lav->getStart().",".$pageNav_lav->getLimit();
...
<div style="margin-left:10px;">
        <div class="pull-left flush-left">
            ...
            ?> | <a <?php echo $id_sort; ?> href="tickets.php?sort=ID&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                    title="<?php echo sprintf(__('Sort by %s %s'), __('Ticket ID'), __($negorder)); ?>">Ordina per numero interno</a></h2>
        </div>
...
<?php csrf_token(); ?>
 ...
 <table border="0" cellspacing="1" cellpadding="2" width="100%">
	 <tr style="background-color:transparent; border-radius:0px; -webkit-box-shadow: 0 0px 0px 0px; -moz-box-shadow: 0 0px 0px 0px; box-shadow: 0 0px 0px 0px;"><td style="width:75%;"><!--prima cella-->
  ...
  <div style="width: 100%;
   ...
   box-shadow: inset 0 0 20px #000000;">
	  <h1><img src="../images/dlnelcc_2.png" style="margin-top:10px;margin-left:10px">&nbsp;Da lavorare nel c.c.&nbsp;<?php if($thisstaff->getDeptId()==5 || $thisstaff->getDeptId()==6 ) {echo "Planner";}elseif($thisstaff->getDeptId()==7){echo "Laboratorio";}elseif($thisstaff->getDeptId()==8){echo "Magazzino";}else{echo "Altro";}?></h1>
 <center><table width="99%" border="0" cellspacing="20px" cellpadding="10px" style="border-collapse: separate; border-spacing: 0px 10px; margin-top:10px; margin-bottom:10px; background:transparent; ">
     ...
     <tbody style="border-radius:25px;">
        ...
        if($res && ($num=count($results))):
            ...
            foreach ($results as $row) {
                ...
                if($row['status']=="Transferred" || $row['status']=="Planning" || $row['status']=="Riparato LAB" || $row['status']=="Lavorato magazzino" || $row['status']=="Non risolto" || $row['status']=="Da validare PLN") {
                ?>
            <tr id="<?php echo $row['ticket_id']; ?>" style="border-radius: 12px;  padding-top:10px; -webkit-box-shadow:1px 1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px 1px  black;  box-shadow: 1px 1px 1px 1px  black;">
               ...
               if ($row['imac']==1) { //backend per me
                    ...
                    ?>
                <td align="center" class="nohover" width="1%" style="background:<?php echo $ticket_color;?>; border-radius:12px 0px 0px 12px;  padding-top:10px; -moz-border-radius:12px 0px 0px 12px; -webkit-border-radius:12px 0px 0px 12px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                    <img src="../images/imac.png">
                </td>
                <?php } else { ?>
                 <td align="center" width="1%" nowrap  style="background:<?php echo $ticket_color;?>; border-radius:12px 0px 0px 12px;  padding-top:10px; -moz-border-radius:12px 0px 0px 12px; -webkit-border-radius:12px 0px 0px 12px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">&nbsp;</td>
                 <?php }?>
                 <?php if ($thisstaff->getId()==1 OR $thisstaff->getId()==3) { //backend per me?>
                 <td align="center"  width="3%" class="nohover" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                    <input class="ckb" type="checkbox" name="tids[]"
                        value="<?php echo $row['ticket_id']; ?>" <?php echo $sel?'checked="checked"':''; ?>>
                </td>
                <?php } ?>
                <td title="<?php echo $row['email']; ?>" width="1%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                ...
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Ticket cliente:</strong><br><?php echo $row['ref_num'];?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Transfer date:</strong><br><?php echo $row['name']=='Poste'?date('d/m/Y H:i',$row['zz_date1']):Format::db_datetime($row['ticket_created']);?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Data scadenza:</strong><br><?php echo Format::db_datetime($row['duedate']); ?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Cliente:</strong><br><?php echo Format::htmlchars(
                ...
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Stato interno:</strong><br><?php echo ucfirst($row['status']);?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Stato cliente:</strong><br><?php echo  !empty($row['status_sym'])?$row['status_sym']:'Non disponibile';?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Gruppo:</strong><br>
                ...
                elseif($row['name']=='Poste Extra'){echo "PT_EXTRA";}
                elseif($row['name']=='APOGEO'){echo "APO_MAN";}
                ?>
                </td>
                <td width="3%" align="center" class="nohover" style="background:<?php echo $ticket_color;?>; border-radius:0px 12px 12px 0px;  padding-top:10px; -moz-border-radius:0px 12px 12px 0px; -webkit-border-radius:0px 12px 12px 0px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 </td><td style="width:25%;"><!--seconda cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-asegnati.png" style="margin-top:10px;margin-left:10px">&nbsp;Sospesi/Attesa P.</h1><center>
 <center>
 <table width="99%" border="0"  style="border-collapse: separate; border-spacing: 0px 2px; margin-top:10px; margin-bottom:10px; background:transparent; ">
            ...
            foreach ($results_sos as $row) {
             ...
             <tr id="<?php echo $row['ticket_id']; ?>">
               ...
               if ($row['imac']==1) { //backend per me
                    ...
                    ?>
                <td align="center" width="20%" class="nohover" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:12px 0px 0px 0px;  padding-top:10px; -moz-border-radius:12px 0px 0px 0px; -webkit-border-radius:12px 0px 0px 0px;"><img height="25px" src="../images/imac.png">
                </td>
                 <?php } else { ?>
                 <td align="center" nowrap  width="20%" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:12px 0px 0px 0px;  padding-top:10px; -moz-border-radius:12px 0px 0px 0px; -webkit-border-radius:12px 0px 0px 0px;">&nbsp;</td>
                 <?php }?>

                 <td align="center" nowrap  width="60%" colspan="2" style="background:<?php echo $ticket_color;?>;  -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Cliente:&nbsp;</strong><?php echo Format::htmlchars(
                        Format::truncate($row['name'], 22, strpos($row['name'], '@'))); ?>&nbsp;</td>

                 <td align="center"  width="20%" class="nohover" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:0px 12px 0px 0px;  padding-top:10px; -moz-border-radius:0px 12px 0px 0px; -webkit-border-radius:0px 12px 0px 0px;">
					<?php if($row['active']=="0" && $row['pc_flag']!="1"){echo '<img src="../images/inactive.png">';
					}elseif($row['active']=="1" && $row['status_sym']!="Sollecitato a Manutentore" && $row['pc_flag']!="1"){echo '<img src="../images/active.png">';
					}elseif($row['status_sym']=="Sollecitato a Manutentore"){echo '<img src="../images/sospeso.png">';
					}elseif($row['pc_flag']=="1"){echo '<img src="../images/disallineato.png">';
                 ...
                 <td align="center" colspan="2"  width="50%" title="<?php echo $row['email']; ?>" nowrap style="background:<?php echo $ticket_color;?>; border-right: 1px solid #396E42; border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                  <a class="Icon <?php echo strtolower($row['source']); ?>Ticket ticketPreview"
                    title="<?php echo __('Preview Ticket'); ?>"
                    href="tickets.php?id=<?php echo $row['ticket_id']; ?>"><strong>Ticket Nr:<br></strong><?php echo $tid; ?></a></td>

                 <td align="center" nowrap  width="50%" colspan="2" style="background:<?php echo $ticket_color;?>;  border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Ticket cliente:<br></strong><?php echo $row['ref_num']; ?></td>

                 </tr>

                 <tr>
                 <td align="center" nowrap width="50%" colspan="2" style="background:<?php echo $ticket_color;?>; border-right: 1px solid #396E42; border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:0px 0px 0px 12px;  padding-top:10px; -moz-border-radius:0px 0px 0px 12px; -webkit-border-radius:0px 0px 0px 12px;"><strong>Transfer date:</strong><br><?php echo $row['name']=='Poste'?date('d/m/Y H:i',$row['zz_date1']):Format::db_datetime($row['ticket_created']);?></td>

                 <td align="center" colspan="2" width="50%" nowrap style="background:<?php echo $ticket_color;?>; border-top: 1px solid #396E42; border-radius:0px 0px 12px 0px;  padding-top:10px; -moz-border-radius:0px 0px 12px 0px; -webkit-border-radius:0px 0px 12px 0px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px   black;"><strong>Data scadenza:</strong><br><?php echo Format::db_datetime($row['duedate']); ?></td>
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 <tr style="background-color:transparent; border-radius:0px; -webkit-box-shadow: 0 0px 0px 0px; -moz-box-shadow: 0 0px 0px 0px; box-shadow: 0 0px 0px 0px;"><td style="width:75%;"><!--terza cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-il.png" style="margin-top:10px;margin-left:10px">&nbsp;Ticket in lavorazione</h1><center>
 <table width="99%" border="0" cellspacing="20px" cellpadding="10px" style="border-collapse: separate; border-spacing: 0px 10px; margin-top:10px; margin-bottom:10px; background:transparent; ">
           ...
           <tr id="<?php echo $row['ticket_id']; ?>" style="border-radius: 12px;  padding-top:10px; -webkit-box-shadow:1px 1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px 1px  black;  box-shadow: 1px 1px 1px 1px  black;">
               ...
               if ($row['imac']==1) { //backend per me
                ...
                <?php } else { ?>
                 <td align="center" width="1%" nowrap  style="background:<?php echo $ticket_color;?>; border-radius:12px 0px 0px 12px;  padding-top:10px; -moz-border-radius:12px 0px 0px 12px; -webkit-border-radius:12px 0px 0px 12px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">&nbsp;</td>
                 <?php }?>
                <td title="<?php echo $row['email']; ?>" width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                  <a class="Icon <?php echo strtolower($row['source']); ?>Ticket ticketPreview"
                    title="<?php echo __('Preview Ticket'); ?>"
                    href="tickets.php?id=<?php echo $row['ticket_id']; ?>"><?php echo "<strong>Ticket Nr:</strong><br>".$tid; ?></a></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Ticket cliente:</strong><br><?php echo $row['ref_num'];?></td>
                ...
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Stato interno:</strong><br><?php echo ucfirst($row['status'])!='Assegnato'?ucfirst($row['status']):ucfirst($row['status']).' ('.$row['lastname'].')';?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Stato cliente:</strong><br><?php echo  !empty($row['status_sym'])?$row['status_sym']:'Non disponibile';?></td>
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Gruppo:</strong><br>
                <?php if($row['name']=='Poste'){echo $row['group_last_name']=='GESTIONE_ATTESE'?'GA':$row['group_last_name'];}
                elseif($row['name']=='Equitalia'){echo "EQUI_MAN";}
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 </td><td style="width:25%;"><!--quarta cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-il-cc.png" style="margin-top:10px;margin-left:10px">&nbsp;Da dismettere</h1><center>
  <table width="99%" border="0"  style="border-collapse: separate; border-spacing: 0px 2px; margin-top:10px; margin-bottom:10px; background:transparent; ">
     <tbody style="border-radius:25px;">
        <?php
        // Setup Subject field for display
           ...
           <?php //CONTROLLO STATI AMMESSI
              ...
              <tr id="<?php echo $row['ticket_id']; ?>">
               ...
               if ($row['imac']==1) { //backend per me
                    ...
                    ?>
                <td align="center" width="20%" class="nohover" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:12px 0px 0px 0px;  padding-top:10px; -moz-border-radius:12px 0px 0px 0px; -webkit-border-radius:12px 0px 0px 0px;">
                    <img src="../images/imac.png">
                </td>
                 <?php } else { ?>
                 <td align="center" nowrap  width="20%" style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:12px 0px 0px 0px;  padding-top:10px; -moz-border-radius:12px 0px 0px 0px; -webkit-border-radius:12px 0px 0px 0px;">&nbsp;</td>
...
<div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width: 100%;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow: inset 0 0 20px #000000;">
	  <h1><img src="../images/dlnelcc_2.png" style="margin-top:10px;margin-left:10px"><?php if(strtolower($_REQUEST['status'])==="closed" AND $_REQUEST['a']!='search' AND !isset($_REQUEST['advsid'])) { echo "&nbsp;Ticket Chiusi"; } if($_REQUEST['a']=='search' || isset($_REQUEST['advsid'])) { echo "&nbsp;Risultati della ricerca"; }?> <?php if($_REQUEST['status']=='disallineati') { echo "&nbsp;Ticket Disallineati"; }?></h1>
 <center><table width="99%" border="0" cellspacing="20px" cellpadding="10px" style="border-collapse: separate; border-spacing: 0px 10px; margin-top:10px; margin-bottom:10px; background:transparent; ">
        ...
        if($res_exp && ($num=count($results_exp))):
         ...
         <tr id="<?php echo $row['ticket_id']; ?>" style="border-radius: 12px;  padding-top:10px; -webkit-box-shadow:1px 1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px 1px  black;  box-shadow: 1px 1px 1px 1px  black;">
               ...
               if ($row['imac']==1) { //backend per me
                ...
                <td width="3%" nowrap style="background:<?php echo $ticket_color;?>; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                        <a <?php echo $staff_sort; ?> href="tickets.php?sort=staff&order=<?php echo $negorder; ?><?php echo $qstr; ?>"
                            title="<?php echo sprintf(__('Sort by %s %s'), __("Closing Agent's Name"), __($negorder)); ?>"><?php echo __('Closed By').':'; ?></a><br><?php echo $row['pln_alpha']==1?'Poste s.p.a.':$lc;?></td>
                <?php }?>
                <td width="3%" align="center" class="nohover" style="background:<?php echo $ticket_color;?>; border-radius:0px 12px 12px 0px;  padding-top:10px; -moz-border-radius:0px 12px 12px 0px; -webkit-border-radius:0px 12px 12px 0px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
					<?php if($row['active']=="0" && $row['pc_flag']!="1"){echo '<img src="../images/inactive.png">';
					}elseif($row['active']=="1" && $row['status_sym']!="Sollecitato a Manutentore" && $row['pc_flag']!="1"){echo '<img src="../images/active.png">';
