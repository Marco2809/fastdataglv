...
$total=db_count("SELECT count(CASE WHEN status.name='In carico al laboratorio' THEN 1 END) $qfrom $sjoin $qwhere");
$total_sos=db_count("SELECT count(CASE WHEN status.name='Da validare LAB' or status.name='Attesa cliente' THEN 1 END) $qfrom $sjoin $qwhere");
$total_lav=db_count("SELECT count(CASE WHEN status.name='In carico Tec. LAB' THEN 1 END) $qfrom $sjoin $qwhere");
$total_dis=db_count("SELECT count(CASE WHEN status.name='Non riparato' THEN 1 END) $qfrom $sjoin $qwhere");
...
$query="$qselect $qfrom $qwhere "."AND (ticket.status_id=12)"." ORDER BY $order_by $order LIMIT ".$pageNav->getStart().",".$pageNav->getLimit();
//echo $query;
//$hash = md5($query);
...
$query_sos="$qselect $qfrom $qwhere "."AND (ticket.status_id=17 or ticket.status_id=21)"." ORDER BY $order_by $order LIMIT ".$pageNav_sos->getStart().",".$pageNav_sos->getLimit();
$res_sos = db_query($query_sos);
$showing_sos=db_num_rows($res_sos)? ' &mdash; '.$pageNav_sos->showing():"";

$query_dis="$qselect $qfrom $qwhere "."AND (ticket.status_id=18)"." ORDER BY $order_by $order LIMIT ".$pageNav_dis->getStart().",".$pageNav_dis->getLimit();
$res_dis = db_query($query_dis);
$showing_dis=db_num_rows($res_dis)? ' &mdash; '.$pageNav_dis->showing():"";

$query_lav="$qselect $qfrom $qwhere "."AND (ticket.status_id=16)"." ORDER BY $order_by $order LIMIT ".$pageNav_lav->getStart().",".$pageNav_lav->getLimit();
...
<?php csrf_token(); ?>
 ...
 <table border="0" cellspacing="1" cellpadding="2" width="100%">
  ...
  <div style="width: 100%;
   ...
   box-shadow: inset 0 0 20px #000000;">
	  <h1><img src="../images/dlnelcc_2.png" style="margin-top:10px;margin-left:10px">&nbsp;Da lavorare nel c.c. Laboratorio</h1>
 <center><table width="99%" border="0" cellspacing="20px" cellpadding="10px" style="border-collapse: separate; border-spacing: 0px 10px; margin-top:10px; margin-bottom:10px; background:transparent; ">
     ...
     <tbody style="border-radius:25px;">
        ...
        if($res && ($num=count($results))):
            ...
            foreach ($results as $row) {
                ...
                if($row['status']=="In carico al laboratorio") {
                ?> 
          <tr id="<?php echo $row['ticket_id']; ?>" style="border-radius: 12px;  padding-top:10px; -webkit-box-shadow:1px 1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px 1px  black;  box-shadow: 1px 1px 1px 1px  black;">
               ...
               if ($thisstaff->getId()==1) { //backend per me
                    $sel=false;
                    if($ids && in_array($row['ticket_id'], $ids))
                        $sel=true;
                    ?>
                <td align="center" class="nohover" width="8" style="background:#ffffff; border-radius:12px 0px 0px 12px;  padding-top:10px; -moz-border-radius:12px 0px 0px 12px; -webkit-border-radius:12px 0px 0px 12px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                ...
                <td width="3%" nowrap style="background:#ffffff; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Transfer date:</strong><br><?php echo date('d/m/Y H:i',$row['zz_date1']);?></td>
                ...
                <td width="3%" nowrap style="background:#ffffff; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Stato cliente:</strong><br><?php echo $row['status_sym'];?></td>
                <td width="3%" nowrap style="background:#ffffff; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><?php echo "<strong>Gruppo:</strong><br>".Format::truncate($row['group_last_name'],40);?></td>
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 </td><td style="width:auto;"><!--seconda cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-asegnati.png" style="margin-top:10px;margin-left:10px">&nbsp;Da validare</h1><center>
 <center>
 <table width="99%" border="0"  style="border-collapse: separate; border-spacing: 0px 2px; margin-top:10px; margin-bottom:10px; background:transparent; ">
     ...
     <tbody style="border-radius:25px;">
        ...
        if($res_sos && ($num=count($results_sos))):
            ...
            foreach ($results_sos as $row) {
                ...
                ?>
                <?php //CONTROLLO STATI AMMESSI
                if($row['status']=="Da validare LAB" || $row['status']=="Attesa cliente") {
                ?>
             <tr id="<?php echo $row['ticket_id']; ?>">
                <td>
                 ...
                 <?php } else { ?>
                 <td align="center" nowrap  width="20%" style="background:#82AA63; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:12px 0px 0px 0px;  padding-top:10px; -moz-border-radius:12px 0px 0px 0px; -webkit-border-radius:12px 0px 0px 0px;">&nbsp;</td>
                 <?php }?>

                 <td align="center" nowrap  width="60%" colspan="2" style="background:#82AA63;  -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Cliente:&nbsp;</strong><?php echo Format::htmlchars(
                        Format::truncate($row['name'], 22, strpos($row['name'], '@'))); ?>&nbsp;</td>

                 <td align="center"  width="20%" class="nohover" style="background:#82AA63; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:0px 12px 0px 0px;  padding-top:10px; -moz-border-radius:0px 12px 0px 0px; -webkit-border-radius:0px 12px 0px 0px;">
					<?php if($row['active']=="0"){echo '<img src="../images/inactive.png">'; 
					}elseif($row['active']=="1" and $row['status_sym']!="Sollecitato a Manutentore"){echo '<img src="../images/active.png">';
					}elseif($row['status_sym']=="Sollecitato a Manutentore"){echo '<img src="../images/sospeso.png">';
					}else{echo "&nbsp;";}?>
                 ...
                 <td align="center" colspan="2"  width="50%" title="<?php echo $row['email']; ?>" nowrap style="background:#82AA63; border-right: 1px solid #396E42; border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;">
                  <a class="Icon <?php echo strtolower($row['source']); ?>Ticket ticketPreview"
                    title="<?php echo __('Preview Ticket'); ?>"
                    href="tickets.php?id=<?php echo $row['ticket_id']; ?>"><strong>Ticket Nr:<br></strong><?php echo $tid; ?></a></td>

                 <td align="center" nowrap  width="50%" colspan="2" style="background:#82AA63;  border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black;"><strong>Ticket cliente:<br></strong><?php echo $row['ref_num']; ?></td>

                 </tr>

                 <tr>
                 <td align="center" nowrap width="50%" colspan="2" style="background:#82AA63; border-right: 1px solid #396E42; border-top: 1px solid #396E42; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px  black; border-radius:0px 0px 0px 12px;  padding-top:10px; -moz-border-radius:0px 0px 0px 12px; -webkit-border-radius:0px 0px 0px 12px;"><strong>Transfer date:</strong><br><?php echo date('d/m/Y H:s', $row['zz_date1']);?></td>

                 <td align="center" colspan="2" width="50%" nowrap style="background:#82AA63; border-top: 1px solid #396E42; border-radius:0px 0px 12px 0px;  padding-top:10px; -moz-border-radius:0px 0px 12px 0px; -webkit-border-radius:0px 0px 12px 0px; -webkit-box-shadow:1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px  black;  box-shadow: 1px 1px 1px   black;"><strong>Data scadenza:</strong><br><?php echo Format::db_datetime($row['duedate']); ?></td>
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 <tr style="background-color:transparent; border-radius:0px; -webkit-box-shadow: 0 0px 0px 0px; -moz-box-shadow: 0 0px 0px 0px; box-shadow: 0 0px 0px 0px;"><td style="width:auto;"><!--terza cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-il.png" style="margin-top:10px;margin-left:10px">&nbsp;Ticket in carico ai tecnici</h1><center>
 <table width="99%" border="0" cellspacing="20px" cellpadding="10px" style="border-collapse: separate; border-spacing: 0px 10px; margin-top:10px; margin-bottom:10px; background:transparent; ">
     ...
     <tbody style="border-radius:25px;">
        ...
        if($res_lav && ($num=count($results_lav))):
            ...
            <?php //CONTROLLO STATI AMMESSI
                if($row['status']=="In carico Tec. LAB") {
                ?>     
           <tr id="<?php echo $row['ticket_id']; ?>" style="border-radius: 12px;  padding-top:10px; -webkit-box-shadow:1px 1px 1px 1px  black;-moz-box-shadow: 1px 1px 1px 1px  black;  box-shadow: 1px 1px 1px 1px  black;">
                <?php //if($thisstaff->canManageTickets()) {
               if ($thisstaff->getId()==1) { //backend per me
    ...
    if ($num>0) { //if we actually had any tickets returned.
	 ...
	 </td><td style="width:auto;"><!--quarta cella-->
	 <div style="width: 100%; height:auto; overflow:auto; float: left;">
  <div style="width:100%;
    height:500px;
	margin-right:auto;
   ...
   -webkit-box-shadow: inset 0 0 20px #000000;
   box-shadow:         inset 0 0 20px #000000;">
	  <h1><img src="../images/tck-il-cc.png" style="margin-top:10px;margin-left:10px">&nbsp;Non riparato</h1><center>
  <table width="99%" border="0"  style="border-collapse: separate; border-spacing: 0px 2px; margin-top:10px; margin-bottom:10px; background:transparent; ">   
     <tbody style="border-radius:25px;">
        <?php
        // Setup Subject field for display
