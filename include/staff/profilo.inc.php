...
<!--TECNICI -->
<?php  if ($thisstaff->getDeptId()!=8 AND $thisstaff->getDeptId()!=9 AND $thisstaff->getDeptId()!=10 AND $thisstaff->getDeptId()!=11 AND $thisstaff->getId()!=2 AND $thisstaff->getDeptId()!=12) {?>
<div style="height:472px;
 ...
 <table width="90%" border="0"  style="border-collapse: separate; border-spacing: 0px 2px; margin-top:-20px; margin-bottom:10px; background:transparent; ">
     ...
     <tbody style="border-radius:25px;">
        ...
        $query ='SELECT user.name,ticket.ticket_id FROM '.TICKET_TABLE.' ticket '.
...
?>
             ...
             <tr>
                <td>
                 ...
                 <?php $z=0; foreach ($results as $risultato) { ?>
                 <!--<tr>
...
<div style="width: 98%;">
 ...
 include('tickets_tecnico.inc.php');
 ?>
</div></div>
