...
$title=($cfg && is_object($cfg) && $cfg->getTitle())
    ? $cfg->getTitle() : 'Fastdata2 :: '.__('Support Ticket System');
...
<head>
	...
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?a7d44f8" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?a7d44f8" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?a7d44f8" media="print"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/typeahead.css?a7d44f8"
         media="screen" />
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css?a7d44f8"
        rel="stylesheet" media="screen" />
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?a7d44f8" media="screen"/>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?a7d44f8"/>
    ...
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?a7d44f8"></script>
    ...
    <script src="<?php echo ROOT_PATH; ?>scp/js/bootstrap-typeahead.js?a7d44f8"></script>
